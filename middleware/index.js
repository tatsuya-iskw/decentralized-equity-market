...
router.get('/bidask/get/all', function(req, res) {
  ...
  var store_path = path.join(__dirname, 'hfc-key-store');
	...
	var tx_id = null;
	// var shipmentKey = req.params.shipmentKey;
...
router.get('/corporate/scan', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
...
router.get('/portfolio/get', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
...
router.get('/transaction/get/all', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
...
router.get('/share/buy/corporate-id/2/4F30880E84638F3B4F2DCFE3CC53022CCAE10D491689E0DAC13B85C9C3A8F0E7', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
...
router.get('/share/get/all', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
...
router.get('/share/get/:owner_id', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
  ...
  Fabric_Client.newDefaultKeyValueStore({ path: store_path
  	...
  	const request = {
  		chaincodeId: 'fabcar',
  		fcn: 'fetchSharesByCorporateId',
  		args: ['ab06a741577bf44e459b8c0c163196727f0e0ae1649db3e05c0cb5a3d6213def']
  	};
...
router.get('/share/get/', function(req, res) {
	res.setHeader('Access-Control-Allow-Origin', 'http://localhost:9999');
	res.setHeader('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE');
	res.setHeader('Access-Control-Allow-Headers', 'X-Requested-With,content-type');
	res.setHeader('Access-Control-Allow-Credentials', true);
  ...
  Fabric_Client.newDefaultKeyValueStore({ path: store_path
  	...
  	const request = {
  		chaincodeId: 'fabcar',
  		fcn: 'fetchSharesByUserId',
  		args: ['4F30880E84638F3B4F2DCFE3CC53022CCAE10D491689E0DAC13B85C9C3A8F0E7']
  	};
